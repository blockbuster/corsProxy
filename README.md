...
This is a sample template for corsProxy - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name corsproxy --tail
```
...
```bash
aws cloudformation delete-stack --stack-name corsproxy
```
